 ...
 */
export class WebGLIsotropicBlur {
    config;
    resources = null;
    currentWidth = 0;
    currentHeight = 0;
     ...
     */
    runBlurPass(gl, program, inputTexture, outputTexture, kernel, width, height) {
    ...
    async blur(input, sigma) {
        ...
        this.runBlurPass(gl, this.resources.horizontalBlurProgram, this.textures[0], this.textures[1], paddedKernel, width, height);
        // Vertical blur pass: texture[1] -> texture[2]
        this.runBlurPass(gl, this.resources.verticalBlurProgram, this.textures[1], this.textures[2], paddedKernel, width, height);
        // Read back result
        gl.bindFramebuffer(gl.FRAMEBUFFER, this.framebuffer);
 ...
 */
export class WebGLFlowGuidedBlur {
    config;
    flowField;
    resources = null;
    currentWidth = 0;
...
//# sourceMappingURL=blur-webgl.js.map