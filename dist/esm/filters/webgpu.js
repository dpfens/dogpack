 ...
 */
import { DEFAULT_MEDIAN_CONFIG, DEFAULT_KUWAHARA_CONFIG, DEFAULT_BILATERAL_CONFIG, DEFAULT_CONTRAST_ENHANCEMENT_CONFIG, DEFAULT_QUANTIZER_CONFIG, DEFAULT_GAUSSIAN_CONFIG, } from '../interfaces/base.js';
 ...
 */
export async function getWebGPUUnsupportedReason() {
 ...
 */
export class GPUBilateralFilter extends BaseWebGPUStrategy {
...
export class GPUMedianFilter extends BaseWebGPUStrategy {
    static async isSupported() {
        return isWebGLComputeSupported() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
...
/* Kuwahara Filter                                                       */
/* ==================================================================== */
export class GPUKuwaharaFilter extends BaseWebGPUStrategy {
    static async isSupported() {
        return isWebGLComputeSupported() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
...
/* ==================================================================== */
export class GPUGaussianBlur extends BaseWebGPUStrategy {
    static async isSupported() {
        return isWebGLComputeSupported() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
...
/* ==================================================================== */
export class GPUContrastEnhancer extends BaseWebGPUStrategy {
    static async isSupported() {
        return isWebGLComputeSupported() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
...
/* Quantizer                                                             */
/* ==================================================================== */
export class GPUQuantizer extends BaseWebGPUStrategy {
    static async isSupported() {
        return isWebGLComputeSupported() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
