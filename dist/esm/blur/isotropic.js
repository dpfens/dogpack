 ...
 */
export class CPUIsotropicBlur extends BaseCPUStrategy {
    config;
    constructor(config = {}) {
        super();
 ...
 */
export class WebGLIsotropicBlur extends BaseWebGLStrategy {
    config;
    resources = null;
    currentWidth = 0;
    currentHeight = 0;
 ...
 */
export class WebGPUIsotropicBlur extends BaseWebGPUStrategy {
    config;
    resources = null;
