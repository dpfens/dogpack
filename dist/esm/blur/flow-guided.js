...
export class CPUFlowGuidedBlur extends BaseCPUStrategy {
    flowField;
    config;
 ...
 */
export class WebGLFlowGuidedBlur extends BaseWebGLStrategy {
    config;
    flowField;
    resources = null;
    currentWidth = 0;
 ...
 */
export class WebGPUFlowGuidedBlur extends BaseWebGPUStrategy {
    config;
    flowField;
    resources = null;
        ...
        const flowPipeline = device.createComputePipeline({
            ...
            compute: {
                module: device.createShaderModule({
                    code: FLOW_BLUR_SHADER_SOURCE_WEBGPU,
                }),
                entryPoint: 'main',
            },
        });
