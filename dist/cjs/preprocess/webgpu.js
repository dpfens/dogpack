...
class GPUBilateralFilter extends base_js_1.BaseWebGPUStrategy {
    ...
    static async isSupported() {
        return (0, index_js_1.isWebGLComputeSupported)() && (await getWebGPUUnsupportedReason()) === undefined;
    }
...
class GPUGaussianBlur extends base_js_1.BaseWebGPUStrategy {
    ...
    async process(input) {
        ...
        const kernel = (0, index_js_1.generateGaussianKernel)(this.sigma, kernelSize);
        const uniformData = new ArrayBuffer(16);
        const u32View = new Uint32Array(uniformData);
        u32View[0] = width;
        u32View[1] = height;
