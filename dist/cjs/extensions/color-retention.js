...
exports.Presets = exports.PostProcessors = exports.ColorTransforms = exports.MaskTransforms = exports.BlendFunctions = exports.ColorRetentionBuilder = exports.ColorRetentionStrategy = void 0;
...
class ColorRetentionStrategy {
     ...
     */
    static preset(name) {
        return new ColorRetentionStrategy(exports.Presets[name]);
    }
    /**
...
exports.ColorRetentionStrategy = ColorRetentionStrategy;
// =============================================================================
// Builder Pattern
// =============================================================================
/**
...
exports.ColorRetentionBuilder = ColorRetentionBuilder;
// =============================================================================
...
exports.Presets = {
     ...
     */
    coloredEdges: {
        blend: exports.BlendFunctions.coloredEdges(1.0),
    },
    /**
     * Painterly: soft, integrated tinted edges
     */
    painterly: {
        maskTransformChain: [exports.MaskTransforms.gamma(0.85)],
        colorTransformChain: [exports.ColorTransforms.saturation(1.1)],
        blend: exports.BlendFunctions.tintedLines(0.7),
        postProcessChain: [exports.PostProcessors.vignette(0.15)],
    },
    /**
     * Vintage: muted colors with soft grain
     */
    vintage: {
        maskTransformChain: [exports.MaskTransforms.contrast(0.9)],
        colorTransformChain: [
            exports.ColorTransforms.saturation(0.7),
            exports.ColorTransforms.sepia(0.3),
        ],
        blend: exports.BlendFunctions.softLight,
        postProcessChain: [exports.PostProcessors.grain(0.03)],
    },
    /**
     * Bold: high contrast with boosted saturation
     */
    bold: {
        maskTransformChain: [exports.MaskTransforms.contrast(1.3)],
        colorTransformChain: [
            exports.ColorTransforms.saturation(1.3),
            exports.ColorTransforms.contrast(1.1),
        ],
        blend: exports.BlendFunctions.coloredEdges(1.0),
    },
    /**
    ...
    sketch: {
        maskTransformChain: [
            exports.MaskTransforms.threshold(0.5),
        ],
        blend: exports.BlendFunctions.multiply,
    },
    /**
    ...
    watercolor: {
        maskTransformChain: [
            exports.MaskTransforms.blur(2),
            exports.MaskTransforms.gamma(0.7),
        ],
        colorTransformChain: [
            exports.ColorTransforms.saturation(1.2),
        ],
        blend: exports.BlendFunctions.tintedLines(0.5),
        postProcessChain: [exports.PostProcessors.vignette(0.2)],
    },
};
// =============================================================================
// Helper Functions
