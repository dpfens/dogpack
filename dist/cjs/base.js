...
exports.BaseWebGPUStrategy = exports.BaseWebGLStrategy = exports.BaseCPUStrategy = void 0;
...
exports.BaseCPUStrategy = BaseCPUStrategy;
class BaseWebGLStrategy {
    backend = 'webgl';
    dispose() { } // was missing here — Preprocessor/ETFComputer both require Disposable
    static isSupported() {
        return Promise.resolve((0, index_js_1.isWebGLComputeSupported)());
    }
    /**
...
exports.BaseWebGLStrategy = BaseWebGLStrategy;
...
exports.BaseWebGPUStrategy = BaseWebGPUStrategy;
