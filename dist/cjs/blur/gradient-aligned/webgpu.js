...
exports.WebGPUGradientAlignedBlur = void 0;
/**
...
class WebGPUGradientAlignedBlur {
    ...
    initPipeline() {
        const module = this.device.createShaderModule({ code: webgpu_fragment_wgsl_js_1.default });
...
exports.WebGPUGradientAlignedBlur = WebGPUGradientAlignedBlur;
