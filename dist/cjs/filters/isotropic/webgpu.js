...
exports.WebGPUIsotropicFilter = void 0;
const base_js_1 = require("../../base.js");
const base_js_2 = require("../../interfaces/base.js");
const device_js_1 = require("../../utils/device.js");
const math_js_1 = require("../../utils/math.js");
const webgpu_horizontal_blur_wgsl_js_1 = require("./shaders/webgpu-horizontal-blur.wgsl.js");
const webgpu_vertical_blur_wgsl_js_1 = require("./shaders/webgpu-vertical-blur.wgsl.js");
/**
 ...
 */
class WebGPUIsotropicFilter extends base_js_1.BaseWebGPUStrategy {
    resources = null;
    /**
    ...
    async apply(input, config) {
        const cfg = { ...base_js_2.DEFAULT_ISOTROPIC_BLUR_CONFIG, ...config };
        const { sigma } = cfg;
        if (sigma < 0.1) {
            return {
...
exports.WebGPUIsotropicFilter = WebGPUIsotropicFilter;
