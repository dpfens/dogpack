...
exports.GPUPreprocessingPresets = exports.GPUQuantizer = exports.GPUContrastEnhancer = exports.GPUGaussianBlur = exports.GPUKuwaharaFilter = exports.GPUMedianFilter = exports.GPUBilateralFilter = void 0;
 ...
 */
class GPUBilateralFilter extends base_js_2.BaseWebGPUStrategy {
...
class GPUMedianFilter extends base_js_2.BaseWebGPUStrategy {
    static async isSupported() {
        return (0, device_js_1.isWebGLComputeSupported)() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
...
/* Kuwahara Filter                                                       */
/* ==================================================================== */
class GPUKuwaharaFilter extends base_js_2.BaseWebGPUStrategy {
    static async isSupported() {
        return (0, device_js_1.isWebGLComputeSupported)() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
...
/* ==================================================================== */
class GPUGaussianBlur extends base_js_2.BaseWebGPUStrategy {
    static async isSupported() {
        return (0, device_js_1.isWebGLComputeSupported)() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
    ...
    async apply(input, config) {
        const { width, height } = input;
        const cfg = { ...base_js_1.DEFAULT_GAUSSIAN_CONFIG, ...config };
        if (cfg.sigma < 0.1) {
        ...
        const kernel = (0, math_js_1.generateGaussianKernel)(cfg.sigma, kernelSize);
        const uniformData = new ArrayBuffer(16);
        const u32View = new Uint32Array(uniformData);
        u32View[0] = width;
        u32View[1] = height;
...
/* ==================================================================== */
class GPUContrastEnhancer extends base_js_2.BaseWebGPUStrategy {
    static async isSupported() {
        return (0, device_js_1.isWebGLComputeSupported)() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
     ...
     */
    async apply(input, config) {
        const { blackPoint, whitePoint } = { ...base_js_1.DEFAULT_CONTRAST_ENHANCEMENT_CONFIG, ...config };
        const device = await getWebGPUDevice();
        const { width, height } = input;
...
/* Quantizer                                                             */
/* ==================================================================== */
class GPUQuantizer extends base_js_2.BaseWebGPUStrategy {
    static async isSupported() {
        return (0, device_js_1.isWebGLComputeSupported)() && (await getWebGPUUnsupportedReason()) === undefined;
    }
    static getUnsupportedReason() {
