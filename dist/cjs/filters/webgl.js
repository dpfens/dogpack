...
// ============================================================================
class BilateralFilterWebGL extends base_js_2.BaseWebGLStrategy {
...
// ============================================================================
class GaussianBlurWebGL extends base_js_2.BaseWebGLStrategy {
    static async isSupported() {
        return isWebGLAvailable();
    }
    static async getUnsupportedReason() {
...
// ============================================================================
class MedianFilterWebGL extends base_js_2.BaseWebGLStrategy {
    static async isSupported() {
        return isWebGLAvailable();
    }
    static async getUnsupportedReason() {
...
// ============================================================================
class KuwaharaFilterWebGL extends base_js_2.BaseWebGLStrategy {
    static async isSupported() {
        return isWebGLAvailable();
    }
    static async getUnsupportedReason() {
...
// ============================================================================
class ContrastEnhancerWebGL extends base_js_2.BaseWebGLStrategy {
    static async isSupported() {
        return isWebGLAvailable();
    }
    static async getUnsupportedReason() {
...
// ============================================================================
class QuantizerWebGL extends base_js_2.BaseWebGLStrategy {
    static async isSupported() {
        return isWebGLAvailable();
    }
    static async getUnsupportedReason() {
    ...
    async apply(input, config) {
        const levels = config.levels ?? base_js_1.DEFAULT_QUANTIZER_CONFIG.levels;
        const gl = getGL();
        if (!gl) {
