 ...
 */
import { type ChannelImage, type BilateralFilterConfig, type MedianFilterConfig, type KuwaharaFilterConfig, type EdgeAwareFilterCore, DEFAULT_BILATERAL_CONFIG, DEFAULT_MEDIAN_CONFIG, DEFAULT_KUWAHARA_CONFIG, type GaussianConfig, DEFAULT_GAUSSIAN_CONFIG, type ContrastEnhancementConfig, DEFAULT_CONTRAST_ENHANCEMENT_CONFIG, type QuantizerConfig, DEFAULT_QUANTIZER_CONFIG } from '../interfaces/base.js';
...
export class BilateralFilterWebGL extends BaseWebGLStrategy implements EdgeAwareFilterCore<BilateralFilterConfig> {
...
export class GaussianBlurWebGL extends BaseWebGLStrategy implements EdgeAwareFilterCore<GaussianConfig> {
...
export class MedianFilterWebGL extends BaseWebGLStrategy implements EdgeAwareFilterCore<MedianFilterConfig> {
  static async isSupported(): Promise<boolean> {
    return isWebGLAvailable();
  }
...
export class KuwaharaFilterWebGL extends BaseWebGLStrategy implements EdgeAwareFilterCore<KuwaharaFilterConfig> {
  static async isSupported(): Promise<boolean> {
    return isWebGLAvailable();
  }
...
export class ContrastEnhancerWebGL extends BaseWebGLStrategy implements EdgeAwareFilterCore<ContrastEnhancementConfig> {
  static async isSupported(): Promise<boolean> {
    return isWebGLAvailable();
  }
...
export class QuantizerWebGL extends BaseWebGLStrategy implements EdgeAwareFilterCore<QuantizerConfig> {
  static async isSupported(): Promise<boolean> {
    return isWebGLAvailable();
  }
