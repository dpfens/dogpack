...
import { type ChannelImage, type BilateralFilterConfig, type MedianFilterConfig, type KuwaharaFilterConfig, DEFAULT_BILATERAL_CONFIG, DEFAULT_MEDIAN_CONFIG, DEFAULT_KUWAHARA_CONFIG, DEFAULT_CONTRAST_ENHANCEMENT_CONFIG, DEFAULT_QUANTIZER_CONFIG, DEFAULT_GAUSSIAN_CONFIG } from '../interfaces/base.js';
import { BaseCPUStrategy } from '../base.js';
import type { ContrastEnhancementConfig, EdgeAwareFilterCore, GaussianConfig, QuantizerConfig } from '../interfaces/base.js';
 ...
 */
export class BilateralFilter extends BaseCPUStrategy implements EdgeAwareFilterCore<BilateralFilterConfig> {
 ...
 */
export class MedianFilter extends BaseCPUStrategy implements EdgeAwareFilterCore<MedianFilterConfig> {
 ...
 */
export class KuwaharaFilter extends BaseCPUStrategy implements EdgeAwareFilterCore<KuwaharaFilterConfig> {
 ...
 */
export class GaussianBlur extends BaseCPUStrategy implements EdgeAwareFilterCore<GaussianConfig>{
 ...
 */
export class ContrastEnhancer extends BaseCPUStrategy implements EdgeAwareFilterCore<ContrastEnhancementConfig> {
 ...
 */
export class Quantizer extends BaseCPUStrategy implements EdgeAwareFilterCore<QuantizerConfig> {
 ...
 * ```
 */
export class LocalVarianceFilter implements EdgeAwareFilterCore<LocalVarianceConfig> {
   ...
   */
  async apply(image: ChannelImage, config: Partial<LocalVarianceConfig>): Promise<ChannelImage> {
 ...
 */
export const EdgeAwareFilterPresets = {
  /**
