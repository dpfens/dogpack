...
export class CPUFlowGuidedBlur extends BaseCPUBlur implements BlurStrategy, FlowGuidedBlurStrategy {
 ...
 * Uses line integral convolution along edge tangent directions
 */
export class WebGLFlowGuidedBlur extends BaseWebGLBlur implements BlurStrategy, FlowGuidedBlurStrategy {
 ...
 */
export class WebGPUFlowGuidedBlur extends BaseWebGPUBlur implements BlurStrategy, FlowGuidedBlurStrategy {
  private config: GLGPUBlurConfig;
  private flowField: FlowField;
