...
import GRADIENT_SHADER from './shaders/webgl/gradient.glsl.js';
import STRUCTURE_TENSOR_SHADER from './shaders/webgl/structural_tensor.glsl.js';
import GAUSSIAN_BLUR_H_SHADER from './shaders/webgl/gaussian_blur_h.glsl.js';
...
interface WebGLResources {
  ...
  finalizeMagnitudeProgram: WebGLProgram;
  // Geometry
